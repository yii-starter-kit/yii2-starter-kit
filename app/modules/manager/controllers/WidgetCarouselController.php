...
use app\modules\manager\models\search\WidgetCarouselItemSearch;
use Yii;
use app\models\WidgetCarousel;
use app\modules\manager\models\search\WidgetCarouselSearch;
...
class WidgetCarouselController extends Controller
{
    ...
    public function actionUpdate($id)
    {
        ...
        $carouselItemsProvider = $searchModel->search(['carousel_id'=>$id]);
