...
class m140703_125207_i18n extends Migration
{
    ...
    public function up()
    {
        ...
        $this->addPrimaryKey('i18_message_pk', '{{%i18n_message}}', ['id', 'language']);
        $this->addForeignKey('fk_message_source_message', '{{%i18n_message}}', 'id', '{{%i18_source_message}}', 'id', 'CASCADE', 'RESTRICT');
    }
